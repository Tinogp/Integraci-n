...
public class Integracion {
    ...
    public static void main(String[] args) {
        ...
        Translator transbf = new Translator(List.of(repTransbf), List.of(transPuerbf), "Translator/frio.xsl"); //mirar archivo
        Translator transbc = new Translator(List.of(repTransbc), List.of(transPuerbc), "Translator/caliente.xsl");
