...
public class TranslatorTest {
    ...
    void testEjecutaTraduccionYPropagaMetadatosFragmento() throws Exception {
        ...
        MensajeFragmento msgEntrada = new MensajeFragmento(docOrigen);
        ...
        // Debe ser un MensajeFragmento
        assertTrue(msgSalida instanceof MensajeFragmento, 
                "El mensaje de salida debería seguir siendo un MensajeFragmento.");
        ...
        assertEquals(ID_FRAGMENTO, ((MensajeFragmento) msgSalida).getIdFragment(), 
