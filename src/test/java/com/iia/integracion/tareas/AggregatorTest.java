...
public class AggregatorTest {
    ...
    private static final String fragmento1 = "<drink><name>cafe</name><type>hot</type></drink>";
    private static final String fragmento2 = "<drink><name>coca-cola</name><type>cold</type></drink>";
    private static final String fragmento3 = "<drink><name>chocolate</name><type>hot</type></drink>";
    private static final String fragmento4 = "<drink><name>agua</name><type>cold</type></drink>";
    ...
    public void testAggregator() {
        ...
        Mensaje msgFrag1 = new Mensaje(crearDocumentoDesdeString(fragmento1), msgOriginal.getId());        
        msgFrag1.setIdFragment(UUID.randomUUID());
        msgFrag1.setTamano(2);        
        Mensaje msgFrag2 = new Mensaje(crearDocumentoDesdeString(fragmento2), msgOriginal.getId());        
        msgFrag2.setIdFragment(UUID.randomUUID());
        msgFrag2.setTamano(2);
        
        Mensaje msgFrag3 = new Mensaje(crearDocumentoDesdeString(fragmento3), msgOriginal2.getId());
        msgFrag3.setIdFragment(UUID.randomUUID());
        msgFrag3.setTamano(2);
        Mensaje msgFrag4 = new Mensaje(crearDocumentoDesdeString(fragmento4), msgOriginal2.getId());        
